          ...
          <Row className="openighour" style={{ marginBottom: 20 }}>
            ...
            <Col md={20} sm={22} xs={22}>
              ...
              <h6 style={{ textAlign: "left" }}>
                Who we are Our App Connected to our official website :
                www.1ayurveda.com
              </h6>
              <div
              ...
              >
                ...
                shown in the comments form, and also the visitors IP address and
                browser user agent string to help spam detection. An anonymised
                string created from your email address (also called a hash) may
                be provided to the Gravatar service to see if you are using it.
                ...
                your comment. Media If you upload images to the website, you
                ...
                any location data from images on the website. Cookies If you
                ...
                for one year. If you visit our login page, we will set a
                ...
                choices. Login cookies last for two days, and screen options
                cookies last for a year. If you select Remember Me your login
                will persist for two weeks. If you log out of your account, the
                login cookies will be removed. If you edit or publish an
                article, an additional cookie will be saved in your browser.
                This cookie includes no personal data and simply indicates the
                ...
                Embedded content from other websites behaves in the exact same
                way as if the visitor has visited the other website. These
                ...
                in to that website. Who we share your data with If you request a
                password reset, your IP address will be included in the reset
                email. How long we retain your data If you leave a comment, the
                comment and its metadata are retained indefinitely. This is so
                we can recognise and approve any follow-up comments
                automatically instead of holding them in a moderation queue. For
                ...
                administrators can also see and edit that information. What
                rights you have over your data If you have an account on this
                ...
                security purposes. Where we send your data Visitor comments may
