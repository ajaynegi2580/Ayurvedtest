    ...
    <div>
      <div className="footer_sec">
        <Row className="joinayurvedafamily">
          ...
          <Col md={20} sm={20} xs={22} className="joinayurveda">
            <Row>
              ...
              <Col md={8} sm={14} xs={9} style={{ textAlign: "left" }}>
                <div>
                  <small>
                    Get daily update and healthy life style
                    <br /> routines right in your email
                  </small>
                </div>
              </Col>
                ...
                <Col sm={24} md={11} xs={24}>
                  <Row>
                    ...
                    <Col md={8}>
                      ...
                      <p>
                        506, Spectrum Commercial Centr, Salapose Road,
              ...
              <Row className="footerow2">
                <Col sm={24} md={12} xs={24}>
                  <p className="footercompanyname">
                    @DETROIT CONSULTANTS INDIA PRIVATE LIMITED ALL RIGHTS
                    RESERVED
                  </p>
